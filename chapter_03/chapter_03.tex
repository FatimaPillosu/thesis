\graphicspath{{Figures/Chapter_03}{Tables/Chapter_03}}
...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.65]{conus_domain.png}
...
\begin{table}[htbp]
\centering
\captionof{table}{\textbf{Types of forecasts from ERA5.} The table describes the characteristics of the different forecasts available from ERA5.}
