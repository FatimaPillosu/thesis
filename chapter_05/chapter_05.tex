...
\caption{\textbf{Overall verification scores.} Panel (a) shows the frequency bias (solid lines) for rainfall-based forecasts exceeding the 1-year (in red), 2-year (in purple), 5-year (in lime), 10-year (in cyan), 50-year (in blue), and 100-year (in green) return period. The corresponding coloured shaded areas represent the confidence intervals at 99\% confidence level. Panel (b) shows the areas under the ROC curve.}
