...
As discussed in Section \ref{integrated_experimental_strategy_verification_strategy} in Chapter \ref{integrated_experimental_strategy}, two properties of probabilistic forecasts must be assessed: reliability and discrimination ability. \textit{Contingency tables} provide the foundation for the computation of the verification scores that assess these two properties and will follow in Section \ref{flash_flood_focused_verification_rainfall_based_ff_verif_framework_verification_scores}. 
...
\begin{minipage}{16cm}
\centering
\includegraphics[width=13cm]{chapter_05/figures/contingency_table_prob_fc.png}
\captionsetup{width=16cm, justification=Justified}
