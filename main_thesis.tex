...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \begin{minipage}[c]{0.4\textwidth} % Width for the first image
            \includegraphics[width=3cm]{figures/uor_logo.png}
        \end{minipage}%
        \hspace{2cm} % Space between the images
        \begin{minipage}[c]{0.4\textwidth} % Width for the second image
            \includegraphics[width=5cm]{figures/ecmwf_logo.jpg}
        \end{minipage}
...
% \include{chapter_01}       % Chapter 1
% \include{chapter_02}       % Chapter 2
\include{chapter_03}       % Chapter 3
% \include{chapter_04}       % Chapter 4
% \include{chapter_05}       % Chapter 5
% \include{chapter_06}       % Chapter 6
% \include{chapter_07}       % Chapter 7
% \include{chapter_08}       % Chapter 8
% \include{chapter_09}       % Chapter 9
